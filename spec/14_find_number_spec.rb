...
describe FindNumber do
  ...
  describe '#make_guess' do
    ...
    context 'when min is 0 and max is 9' do
      it 'returns 4' do
        game_guess = game_guessing.make_guess
        expect(game_guess).to eq(4)
      end
    end
  ...
  describe '#game_over?' do
    context 'when guess and random_number are equal' do
      ...
      let(:number_over) { double('number_over') }
      ...
      it 'is game over' do
        allow(number_over).to receive(:value).and_return(8)
    ...
    context 'when guess and random_number are not equal' do
      ...
      it 'is not game over' do
        allow(number_over).to receive(:value).and_return(1)
        result = game_over.game_over?
  ...
  describe '#update_range' do
    ...
    context 'when the guess is less than the answer' do
      ...
      it 'does not update max' do
        expect{ low_guess_game.update_range }.to change { low_guess_game.max }.by(0)
      end
    end
    ...
    context 'when the guess is more than the answer' do
      ...
      it 'does not update min' do
        expect{ high_guess_game.update_range }.to change { high_guess_game.min }.by(0)
      end
    ...
    context 'when the guess is 7, min=5, and max=8' do
      ...
      it 'updates min to the same value as max' do
        expect{ close_guess_game.update_range }.to change { close_guess_game.min }.to(close_guess_game.max)
      end

      it 'does not update max' do
        expect{ close_guess_game.update_range }.to change { close_guess_game.max }.by(0)
      end
    end
  end
end
