...
describe MagicSeven do
  ...
  describe '#subtract_four' do
    context 'when the previous step is 22' do
      it 'returns 18' do
        previous_step = 22
  ...
  describe '#divide_by_two' do
    context 'when the previous step is 44' do
      it 'returns 22' do
        previous_step = 44
  ...
  describe '#play' do
    context 'when the random number is 105' do
      # remove the 'x' before running this test
      it 'will return 7' do
        game = MagicSeven.new(105)
        expect(game.play).to eq(7)
      end
    end

    context 'when the random number is 54' do
      # remove the 'x' before running this test
      it 'will return 7' do
        game = MagicSeven.new(54)
        expect(game.play).to eq(7)
      end
    end
